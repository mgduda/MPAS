MODEL_FORMULATION = -DSECOND_ORDER -DUPPER_LEVEL_FILTER -DMONOTONICITY_FIX -DSINGLE_PRECISION -DCONST_INNER_DIMS -DCONST_NVERTLEVELS=63 -DCONST_MAXEDGES=6 -DCONST_MAXEDGES2=12 -DCONST_NUM_SCALARS=3
