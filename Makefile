MODEL_FORMULATION = -DSECOND_ORDER -DUPPER_LEVEL_FILTER -DMONOTONICITY_FIX -DSINGLE_PRECISION -DCONST_INNER_DIMS -DCONST_NVERTLEVELS=63 -DCONST_MAXEDGES=10 -DCONST_MAXEDGES2=20 -DCONST_NUM_SCALARS=3
