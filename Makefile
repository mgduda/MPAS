MODEL_FORMULATION = -DCONST_INNER_DIMS -DCONST_NVERTLEVELS=55 -DCONST_MAXEDGES=7 -DCONST_MAXEDGES2=14 -DCONST_NUM_SCALARS=9
...
ifort:
	...
	"FFLAGS_OPT = -O3 -convert big_endian -FR -g -traceback" \
	"CFLAGS_OPT = -O3 -g -traceback" \
	"CXXFLAGS_OPT = -O3 -g -traceback" \
	"LDFLAGS_OPT = -O3 -g -traceback" \
